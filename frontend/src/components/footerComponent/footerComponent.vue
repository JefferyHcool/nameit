...
import { LINK } from '@/const/enums.ts'

const designStore = useDesignStore()
const handleChangeTheme = () => {
  const theme = designStore.getTheme
  if (theme == 'light') {
    designStore.setTheme('dark')
  } else {
    designStore.setTheme('light')
  }
}
</script>
...
<template>
  <div id="footer-container">
    <div class="info">
      ...
      <a :href="LINK.GITHUB_LINK" target="_blank"> <span>JefferyHcool/nameit </span></a>
    </div>
  </div>
</template>
